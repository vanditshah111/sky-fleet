...
public class RemoveCrew extends JFrame implements ActionListener{
	...
	RemoveCrew() {
        ...
        JLabel titleLabel = new JLabel("Remove Crew");
        ...
        JLabel modelNoLabel = new JLabel("Crew ID:");
    ...
    {
    	String CrewId = modelNoField.getText(); // Assuming flightId is the input from the frontend
    	String deleteQuery = "DELETE FROM crew WHERE Crew_ID = '" + CrewId + "'";
    	try {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                RemoveCrew addCrew = new RemoveCrew();
