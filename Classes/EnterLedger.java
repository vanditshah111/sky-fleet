...
public class EnterLedger extends JFrame implements ActionListener{
    ...
    EnterLedger() {
        ...
        JLabel titleLabel = new JLabel("Add Ledger Entry");
        ...
        JLabel crewIDLabel = new JLabel("Ledger ID:");
        ...
        JLabel nameLabel = new JLabel("Flight ID:");
        ...
        JLabel genderLabel = new JLabel("Income :");
        ...
        JLabel postLabel = new JLabel("Cost :");
        ...
        errorMsg = new JLabel("Ledger with this ID number already exists! Try again.");
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        String ecs=genderField.getText();
    }
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                EnterLedger EnterLedger = new EnterLedger();
                EnterLedger.setVisible(true);
            }
        });
    }
}
