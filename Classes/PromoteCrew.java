...
import java.sql.*;
public class PromoteCrew extends JFrame implements ActionListener {
    ...
    PromoteCrew() {
        ...
        titleLabel = new JLabel("Promote Crew");
        ...
        modelNoLabel = new JLabel("Crew ID:");
    ...
    public void actionPerformed(ActionEvent e) {
        String s = modelNoField.getText();
            ...
            GridBagConstraints gbc = new GridBagConstraints();
            gbc.insets = new Insets(10, 10, 10, 10);
            String q1 = "SELECT Post, Salary FROM Crew WHERE Crew_ID = '" + s + "'";
            ...
            try {
                ...
                if (resultSet.next()) {
                    ...
                    s1 = resultSet.getString("Post");
                    s2 = resultSet.getInt("Salary");
                } else {
            ...
            currentPostLabel = new JLabel("Current Post:"+s1);
            ...
            currentSalaryLabel = new JLabel("Current Salary:"+s2);
            ...
            enterButton2.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    ...
                    String updateQuery = "UPDATE crew SET Post = '" + newPost + "', Salary = '" + newSalary + "' WHERE Crew_ID = '" + s + "'";
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                PromoteCrew promoteCrew = new PromoteCrew();
